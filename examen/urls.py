...
urlpatterns = [
    ...
    path("capitulo/<int:pk>/marcar/", examen_views.MarcarCapituloView.as_view(), name="marcar_capitulo"),
    path("capitulo/<int:pk>/imprimir/", examen_views.CapituloImpresionView.as_view(), name="capitulo_impresion"),
    ...
    path("perfil/", examen_views.PerfilView.as_view(), name="perfil"),
